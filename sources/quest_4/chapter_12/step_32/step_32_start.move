module robinson::shoreCurrency {
    ...
    // Declare a function mint with parameters admin as signer, to as the recipient address and amount(u64) as the amount of coin which needs to be transferred
